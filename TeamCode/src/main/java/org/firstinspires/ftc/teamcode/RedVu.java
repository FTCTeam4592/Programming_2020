...
@Autonomous(name="REDVU", group="Testing")
//@Disabled


public class RedVu extends SkyStone4592 {

    /* Declare OpMode members. */

    private ElapsedTime     runtime = new ElapsedTime();

    private static final String VUFORIA_KEY = "";
...
//        driveReverse(0.7, 40);
        ...
        while (!isStopRequested()) {
            ...
            if (targetVisible) {
                ...
                strafeLeft(1, 17.5);
                sleep(1000);
                flipArm.setTargetPosition(1); //hopefully this works
                sleep(1000);
                driveForward(1, 7.5);
                sleep(500);
                clampClaw.setPosition(1);
